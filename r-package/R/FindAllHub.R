...
#' @param centrality default is "degree" centrality. Available options are: c("degree", "betweenness","closeness", "eigenvector"). Degree is calculated with sum of weights. Weights are uniform in betweenness and closeness centrality.
#' @param q.method default "BH", input one of the following c("holm", "hochberg", "hommel", "bonferroni", "BH", "BY", "fdr", "none")
